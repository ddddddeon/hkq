...
var dumpPath = config.dumpPath;
var queues = {};

var loadFromDisk = function() {
  console.log('+ loading queues from ' + dumpPath + '...');
  var savedQueues = require(dumpPath);
...
var dumpToDisk = function() {
  console.log('+ dumping queue data to ' + dumpPath + '...');
  fs.writeFile(dumpPath, JSON.stringify(queues), function(err) {
    if (err) {
